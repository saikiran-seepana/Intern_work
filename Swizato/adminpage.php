	...
	<div align="center" style="position: relative; top: 50px;">
		<table style="width:50%;">
			...
			<?php 
				session_start();
				include("db.php");
				echo " <tr><td style='padding:20px'><font size='5px'>To insert in to data base</font></td>
				<td></td>
				<td><a href='admin_insert.html'><input type='submit' name='insert' value='insert'></a></td></tr>";
